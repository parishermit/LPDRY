...
CHINESE_MODEL_PATH = "model/cnn_chs/chs.ckpt"#"model/cnn_chs/chs.ckpt"#"model/cnn_enu/enu.ckpt"
sess = tf.Session()
saver = tf.train.Saver()
saver.restore(sess, CHINESE_MODEL_PATH)

digit_image_path = "../opencv_ml/data/chs_train/sx/282.jpg"#"images/digit.jpg"#/english.jpg"#
...
# ENGLISH_MODEL_PATH = "model/cnn_enu/enu.ckpt"#"model/cnn_chs/chs.ckpt"#"model/cnn_enu/enu.ckpt"
# sess = tf.Session()
# saver = tf.train.Saver()
# saver.restore(sess, ENGLISH_MODEL_PATH)
#
#
# digit_image_path = 'opencv_ml/data/chs_train/sx/282.jpg'#"mypic0.jpg"#"images/digit.jpg"#/english.jpg"#
# # digit_image_path = 'images/digit.jpg'#"mypic0.jpg"#"images/digit.jpg"#/english.jpg"#
# digit_image = load_image(digit_image_path, IMAGE_WIDTH, IMAGE_HEIGHT)
# results = sess.run(y_conv, feed_dict={x: digit_image, rate: 0.0})#keep_prob: 1.0})
# predict = np.argmax(results[0])
