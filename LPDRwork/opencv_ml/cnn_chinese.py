...
with tf.Session() as sess:
    ...
    for epoch in range(1, max_epochs + 1):
        ...
        for i in range(1, iters + 1):
            ...
            _, batch_accuracy = sess.run([train_step, accuracy], feed_dict = { x:batch_x, y_:batch_y, rate:0.5})#keep_prob:0.5 })
            if i % check_step == 0:
    ...
    test_accuracy = accuracy.eval(feed_dict={x: test_data, y_: test_labels, rate:0.0})#keep_prob: 1.0})
